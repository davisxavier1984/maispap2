"""
Módulo para comunicação com APIs externas e gerenciamento de dados relacionados.
"""
...
class APIClient:
    ...
    def _create_session(self) -> requests.Session:
        ...
        session.headers.update({
            ...
            "User-Agent": "Calculadora-PAP/1.0"
        })
...
def consultar_api(codigo_ibge: str, competencia: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        response = api_client.session.get(
            ...
            params=params, 
            timeout=30,
            verify=True  # Removido verify=False por segurança
        )
